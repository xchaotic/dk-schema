...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="root/group | root/group/group | root/group/group/group |
    root/group/group/group/group | root/group/group/group/group/group">
    <xsl:copy>
      <xsl:copy-of select="@*"/>
      <xsl:apply-templates/>
    </xsl:copy>
  ...
  <xsl:template match="root/group/group/group/group/group/group">
    <xsl:copy>
      <xsl:copy-of select="@*"/>
